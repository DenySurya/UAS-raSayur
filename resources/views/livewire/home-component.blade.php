        ...
        <div class="wrap-main-slide">
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
                <div class="item-slide">
                    <img src="{{ asset('assets/images/slide1.jpg')}}" alt="" class="img-slide">
                    <div class="slide-info slide-1">
                        <h2 class="f-title">Hidup sehat dengan <b>Sayur</b></h2>
                        <span class="subtitle">dengan mengonsumsi sayur anda akan menjadi lebih sehat</span>
                        <p class="sale-info">Dimulai dengan harga:<span class="price">Rp.5.000</span></p>
                        <a href="#" class="btn-link">Belanja Sekarang</a>
                    </div>
                </div>
                <div class="item-slide">
                    <img src="{{ asset('assets/images/slide2.jpg')}}" alt="" class="img-slide">
                    <div class="slide-info slide-2">
                        <h2 class="f-title">Diskon 10%</h2>
                        <span class="f-subtitle">Hanya Untuk COD</span>
                        <p class="discount-code">Promo Terbatas</p>
                        <h4 class="s-title">Dapatkan Gratis Ongkir</h4>
                        <p class="s-subtitle">Setiap belanja minimal Rp.50.000</p>
                    </div>
                </div>
                <div class="item-slide">
                    <img src="{{ asset('assets/images/slide3.jpg')}}" alt="" class="img-slide">
                    <div class="slide-info slide-3">
                        <h2 class="f-title">Gudangnya <b>Sayuran Berkualitas</b></h2>
                        <span class="f-subtitle">Sayuran murah hanya ada disini.</span>
                        <p class="sale-info">Mulai dari: <b class="price">Rp.5.000</b></p>
                        <a href="#" class="btn-link">Belanja Sekarang</a>
                    </div>
                </div>
            </div>
