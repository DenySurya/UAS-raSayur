            ...
            <div class="row">
                <div class="topbar-menu-area">
                    <div class="container">
                        <div class="topbar-menu left-menu">
                            <ul>
                                <li class="menu-item">
                                    <a title="Hotline: 081234567890" href="#"><span class="icon label-before fa fa-mobile"></span>Hotline: 081234567890</a>
                                </li>
                            </ul>
                        </div>
                        <div class="topbar-menu right-menu">
                            <ul>
                                ...
                                <li class="menu-item menu-item-has-children parent">
                                    ...
                                    <ul class="submenu curency">
                                        ...
                                        <li class="menu-item">
                                            <a title="Products" href="{{route('admin.products')}}">Semua Produk</a>
                                        </li>
                                        <li class="menu-item">
                                            <a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form') .submit();">Logout</a>
                                        </li>
                ...
                <div class="container">
                    <div class="mid-section main-info-area">
                        ...
                        <div class="wrap-logo-top left-section">
                            <a href="index.html" class="link-to-home"><img src="{{ asset('assets/images/logorasayur.png')}}" alt="mercado"></a>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                                    ...
                                    <div class="wrap-contact-detail">
                                        <ul>
                                            <li>
                                                ...
                                                <p class="contact-txt">Bedugul,Baturiti,Tabana,Bali</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-phone" aria-hidden="true"></i>
                                                <p class="contact-txt">081234567890</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-envelope" aria-hidden="true"></i>
                                                <p class="contact-txt">sukasayur@gmail.com</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            ...
                            <div class="wrap-footer-item">
                                <h3 class="item-header">Panggilan Cepat</h3>
                                <div class="item-content">
                                    <div class="wrap-hotline-footer">
                                        <span class="desc">Panggilan Ini Tidak Berbayar</span>
                                        <b class="phone-number">081234567890</b>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            <div class="wrap-footer-item">
                                <h3 class="item-header">Kami Menggunakan Pembayaran:</h3>
                                <div class="item-content">
                ...
                <div class="coppy-right-box">
                    <div class="container">
                        <div class="coppy-right-item item-left">
                            <p class="coppy-right-text">Copyright © 2021 I Gede Made Deny Surya Gunawan. 1915101037</p>
                        </div>
